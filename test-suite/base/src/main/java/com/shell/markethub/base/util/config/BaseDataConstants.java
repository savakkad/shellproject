...
public class BaseDataConstants{
	...
	public static final String IEXPLORER_DRIVER_PATH ="base\\src\\main\\resources\\drivers\\ie\\IEDriverServer_win64.exe";
	public static final String EDGE_DRIVER_PATH ="base\\src\\main\\resources\\drivers\\ie\\msedgedriver.exe";
	...
	//public static final String PERF_MARKETHUB_URL="http://int.perftest.markethub.shell.com/";
	public static String MARKETHUB_AUT_URL="";
	
	//DTM User Config Store
	public static final String DTM_USER_CONFIG_STORE_PATH = "\\test-output\\user-config\\";
	
	//Author Perf & Prod URL
	public static final String AUTHOR_PERF_URL = "http://10.121.247.10:4502/libs/granite/core/content/login.html?resource=%2F&$$login$$=%24%24login%24%24&j_reason=unknown&j_reason_code=unknown";
	public static final String AUTHOR_PROD_URL = "http://10.121.247.28:4502/libs/granite/core/content/login.html?resource=%2F&";
	public static String AUTHOR_AUT_URL = "";
	
	//Skypad AUT URL
	public static final String SKYPAD_AUT_URL = "https://dcswebappqa-a021a77ef.dispatcher.hana.ondemand.com/webapp/index.html";
