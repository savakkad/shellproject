...
public class Error404Page extends CrossBusinessBasePageObject{
	...
	String pageErrorDigitalData = "page.error";
	String pageErrorCodeDigitalData = "page.errorCode";
	String pageErrorURLDigitalData = "page.errorUrl";
	...
	public String verifyPageErrorDigitalData() throws Exception {
		return getDigitalData(pageErrorDigitalData);
	}
	public String verifyPageErrorCodeDigitalData() throws Exception {
		return getDigitalData(pageErrorCodeDigitalData);
	}
	public String verifyPageErrorURLDigitalData() throws Exception {
		return getDigitalData(pageErrorURLDigitalData);
	}
}
